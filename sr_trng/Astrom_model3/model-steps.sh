...
-samprate 16000 -c Astrom.fileids \
...
../TrainingSet/bw \
 ...
 -ctlfn Astrom.fileids \
 -lsnfn Astrom.transcription \
 -accumdir .

cp -a ../TrainingSet/acoustic-model model3-update-dict
...
../TrainingSet/map_adapt \
    ...
    -accumdir . \
    -mapmeanfn model2/means \
    -mapvarfn model2/variances \
    -mapmixwfn model2/mixture_weights \
    -maptmatfn model2/transition_matrices
